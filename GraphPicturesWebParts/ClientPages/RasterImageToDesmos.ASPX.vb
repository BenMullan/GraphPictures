...
Public Class RasterImageToDesmos : Inherits System.Web.UI.Page
	...
	Protected Sub PerformUploadButton_Click() Handles PerformUploadButton.Click
		...
		Try
			...
			If RasterImageUploader.HasFile Then
				...
				Me.PerformPostUploadTasks(_SaveAsFileName)
	...
	Protected Friend Sub PerformPostUploadTasks(ByVal _RasterFileName$)

		Dim _SVGFileName$ = Global.GraphPictures.WebParts.Resources.GenerateSVGFromUploadedImage(_RasterFileName$)

		Response.Redirect(("/ClientPages/SVGToDesmos.ASPX?SVGFileName=" & _SVGFileName))
